...
export default function Contact() {
  ...
  return (
    <div className="flex flex-col justify-around h-72 mt-64 sm:mb-64">
      <div className="flex flex-col p-4 sm:flex-row justify-around sm:text-2xl lg:text-5xl font-semibold">
      ...
      <div className="flex flex-col sm:mt-40">
        <div className="">
          <CopyToClipboard text="georgeon2016@gmail.com">
            <div className="lg:text-6xl sm:text-4xl text-3xl flex flex-col items-center font-semibold emailContainer">
